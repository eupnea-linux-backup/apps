...
apt-get download xclip libsdl2-2.0-0 libsdl2-image-2.0-0 libjpeg-turbo8 libdecor-0-0 libtiff5 libjbig0
# extract debs
mkdir /tmp/xclip
mkdir /tmp/libsdl2
...
/tmp/appimagetool.AppImage /tmp/kivy_appdir /tmp/eupnea-settings.AppImage
